...
function KanbanCard({
  ...
  }, category), tags.map(t => React.createElement('span', {
    key: t,
    style: {
      fontSize: 11,
      padding: '2px 8px',
  ...
  }, assigneeInitial && React.createElement('div', {
    style: {
      width: 24,
      height: 24,
      borderRadius: '50%',
...
const STATUS = {
  ...
  blocked: {
    ...
    fg: '--status-blocked-fg',
    label: 'Blocked'
  },
  in_progress: {
    bg: '--status-inprogress-bg',
    fg: '--status-inprogress-fg',
    label: 'In Progress'
  },
  review: {
    bg: '--status-review-bg',
...
function Sidebar({
  ...
  }, "Anchor")), company && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: '12px 16px',
      borderBottom: '1px solid var(--sidebar-border)'
    }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/anchor/Sidebar.jsx", error: String((e && e.message) || e) }); }

// ui_kits/anchor/data.js
try { (() => {
window.ANCHOR_DATA = {
  items: [{
    id: '1',
    ...
    id: '4',
    title: 'Add SSO for enterprise plan',
    owner: 'Priya Patel',
    category: 'Feature',
    status: 'review',
    priority: 'high',
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/anchor/data.js", error: String((e && e.message) || e) }); }

// ui_kits/anchor/icons.js
try { (() => {
window.AnchorIcon = function AnchorIcon({
  name,
  size = 16,
  color = 'currentColor',
  style
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/anchor/icons.js", error: String((e && e.message) || e) }); }

// ui_kits/anchor/screens/DashboardScreen.jsx
try { (() => {
function DashboardScreen({
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Acme Co \xB7 Monday, Jul 13")), /*#__PURE__*/React.createElement("div", {
    style: {
    ...
    size: 12,
    color: "#dbeafe"
  }), "Quick Add \u2014 type a task and hit Enter"), /*#__PURE__*/React.createElement("form", {
    ...
    placeholder: "e.g. Fix the checkout timeout bug",
    disabled: parsing,
    style: {
      flex: 1,
      height: 44,
  ...
  }, items.slice(0, 6).map(item => /*#__PURE__*/React.createElement("div", {
    key: item.id,
    onClick: () => onNavigate('kanban'),
    style: {
      display: 'flex',
  ...
  }), "Work Pipeline")), /*#__PURE__*/React.createElement(CardContent, {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/anchor/screens/DashboardScreen.jsx", error: String((e && e.message) || e) }); }
